...
func (s *Server) CreatePost(w http.ResponseWriter, r *http.Request) {
	...
	if uid != post.AuthorID {
		responses.ERROR(w, http.StatusInternalServerError, errors.New(http.StatusText(http.StatusUnprocessableEntity)))
		return
	}
	postCreated, err := post.Save(s.DB)
	if err != nil {
...
func (s *Server) GetPost(w http.ResponseWriter, r *http.Request) {
	...
	post := models.Post{}
	postReceived, err := post.FindByID(s.DB, pid)
	if err != nil {
		responses.ERROR(w, http.StatusInternalServerError, err)
		return
	}
...
func (s *Server) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	postUpdated, err := postUpdate.Update(s.DB, pid)
...
func (s *Server) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	_, err = post.Delete(s.DB, pid, uid)
	if err != nil {
		responses.ERROR(w, http.StatusBadRequest, err)
		return
	}
